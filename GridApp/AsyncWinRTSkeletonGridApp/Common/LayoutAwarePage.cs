...
namespace AsyncWinRTSkeletonGridApp.Common
{
    /// <summary>
    ...
    public class LayoutAwarePage : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.NavigationMode == NavigationMode.New)
            {
                ...
                await this.LoadState(e.Parameter, null);
            }
            else
            {
                ...
                // from cache
                await this.LoadState(e.Parameter, (Dictionary<String, Object>)frameState[this._pageKey]);
            }
        }
        ...
        protected async override void OnNavigatedFrom(NavigationEventArgs e)
        {
            ...
            await this.SaveState(pageState);
        ...
        protected async virtual Task LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {

            /* 
             * Waiting for empty task
             * 
             * When async function does not wait for another async call, it will run sync.
             * But you will have noisy warning by compiller, if you don't want to write this function sync style.
             */
            await Task.Run(() => { });  
        }
        ...
        protected async virtual Task SaveState(Dictionary<String, Object> pageState)
        {
            /* 
             * Waiting for empty task
             * 
